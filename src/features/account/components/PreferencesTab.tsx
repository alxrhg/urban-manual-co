    ...
    <div className="space-y-8">
        ...
        <div className="flex gap-2">
          {[1, 2, 3, 4].map(level => (
            <button
              ...
              className={`flex-1 px-4 py-3 rounded-lg border font-medium transition-all text-sm ${
      ...
      <div className="flex gap-3 pt-4">
        <button
          onClick={saveProfile}
          disabled={saving}
          className="flex items-center justify-center gap-2 px-4 py-2 bg-black dark:bg-white text-white dark:text-black rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-xs font-medium"
        >
          {saving ? (
            <>

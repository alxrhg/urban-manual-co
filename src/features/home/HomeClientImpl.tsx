...
/**
 * Props for HomeClientImpl
 * Receives pre-fetched data from server component
 */
export interface HomeClientImplProps {
  /** Pre-fetched destinations from server - eliminates initial data waterfall */
  initialDestinations?: Destination[];
  /** Pre-fetched city filter options from server */
  initialCities?: string[];
  /** Pre-fetched category filter options from server */

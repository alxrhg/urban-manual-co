...
export function SearchFiltersComponent({
  ...
  return (
    <div className="w-full">
      ...
      {/* Expandable filter panel - inline, pushes content down */}
      {isOpen && (
        <div className="w-full mt-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-lg">

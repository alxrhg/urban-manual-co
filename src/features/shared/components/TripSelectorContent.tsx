    ...
    <div className="pb-6">
      ...
      <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-800">
        <button
          ...
          className="w-full flex items-center gap-3 p-4 rounded-lg bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors"
        >

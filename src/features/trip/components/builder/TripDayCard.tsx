...
function DayEmptyState({
  ...
  return (
    <div className="text-center py-8">
      <p className="text-sm text-gray-400 mb-4">No places added yet</p>
      <button
        onClick={onSuggest}
        disabled={isSuggesting}
        className="inline-flex items-center gap-2 px-4 py-2.5 text-xs font-medium text-gray-900 dark:text-white bg-gray-100 dark:bg-white/10 rounded-full hover:bg-gray-200 dark:hover:bg-white/20 transition-all disabled:opacity-50 hover:scale-[1.02] active:scale-[0.98]"
      >
        {isSuggesting ? (
...
function ActionButton({
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className="flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-gray-500 hover:text-gray-900 dark:hover:text-white bg-gray-50 dark:bg-white/5 rounded-full hover:bg-gray-100 dark:hover:bg-white/10 transition-all disabled:opacity-50 hover:scale-[1.02] active:scale-[0.98]"
    >
      {icon}
      {label}
    </button>

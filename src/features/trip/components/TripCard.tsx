  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] bg-gray-100 dark:bg-gray-800">
        ...
        {/* Status Badge */}
        {statusConfig && (
          <div className={`absolute top-3 left-3 flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium uppercase tracking-wider ${statusConfig.bg} ${statusConfig.text} ring-1 ring-white/10`}>

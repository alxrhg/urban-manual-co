            ...
            >
              ...
              <div className="grid grid-cols-3 sm:flex sm:items-center gap-1 sm:gap-2 p-2 sm:p-2 rounded-lg bg-white dark:bg-gray-900 shadow-lg shadow-black/8 border border-gray-200/50 dark:border-gray-700/50">
                ...
                >
                  ...
                  <span className="text-xs sm:text-xs font-medium text-gray-500">Place</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="text-xs sm:text-xs font-medium text-gray-500">Flight</span>
                </button>
                {onAddHotel && (
                  <button
                  ...
                  >
                    ...
                    <span className="text-xs sm:text-xs font-medium text-gray-500">Hotel</span>
                  </button>
                )}
                {onAddTransport && (
                  <button
                  ...
                  >
                    ...
                    <span className="text-xs sm:text-xs font-medium text-gray-500">Transport</span>
                  </button>
                )}
                <button
                ...
                >
                  ...
                  <span className="text-xs sm:text-xs font-medium text-gray-500">Note</span>
                </button>
              </div>
            </div>

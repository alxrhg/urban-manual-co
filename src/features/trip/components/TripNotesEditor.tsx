  ...
  return (
    ...
    >
      ...
      <button
        {...attributes}
        {...listeners}
        className="mt-1 p-0.5 text-stone-300 dark:text-gray-600 hover:text-stone-500 dark:hover:text-gray-400 cursor-grab active:cursor-grabbing opacity-0 group-hover:opacity-100 transition-opacity"
      >
      ...
      {item.type === 'checkbox' ? (
        <button
          ...
          className={`mt-0.5 flex-shrink-0 transition-colors ${
            item.checked
              ...
              : 'text-stone-400 dark:text-gray-500 hover:text-stone-600 dark:hover:text-gray-400'
          }`}
        >
          {item.checked ? (
        ...
        <span className="mt-1 w-4 h-4 flex-shrink-0 flex items-center justify-center">
          <span className="w-1.5 h-1.5 rounded-full bg-stone-400 dark:bg-gray-500" />
        </span>
      )}
      ...
      {isEditing ? (
        <input
          ...
          className="flex-1 text-sm bg-transparent border-b border-stone-300 dark:border-gray-600 focus:border-stone-900 dark:focus:border-white outline-none py-0.5 text-stone-900 dark:text-white"
        />
      ) : (
        <span
      ...
      <button
        onClick={onDelete}
        className="mt-0.5 p-0.5 text-stone-300 dark:text-gray-600 hover:text-red-500 dark:hover:text-red-400 opacity-0 group-hover:opacity-100 transition-all"
      >
  ...
  return (
    <div className={`${className}`}>
      ...
      {notes.items.length > 0 ? (
        ...
        <p className="text-xs text-stone-400 dark:text-gray-500 italic mb-4">
      ...
      <div className="flex items-center gap-2">
        {/* Type toggle */}
        <div className="flex bg-stone-100 dark:bg-gray-800 rounded-lg p-0.5">
          <button
        ...
        <div className="flex-1 relative">
          <input
            ...
            className="w-full text-sm px-3 py-1.5 rounded-lg border border-stone-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-stone-900 dark:text-white placeholder-stone-400 dark:placeholder-stone-500 focus:outline-none focus:ring-2 focus:ring-stone-900 dark:focus:ring-white focus:ring-offset-1"
          />
        </div>
        ...
        <button
          ...
          className="p-1.5 rounded-lg bg-stone-900 dark:bg-white text-white dark:text-gray-900 disabled:opacity-40 disabled:cursor-not-allowed hover:bg-stone-800 dark:hover:bg-gray-100 transition-colors"
        >

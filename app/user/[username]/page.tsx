              ...
              <div className="flex items-center justify-between mb-2">
                ...
                {isOwnProfile && (
                  <button
                    ...
                    className="px-6 py-2 text-sm font-medium border border-gray-200 dark:border-gray-800 rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors"
                  >
                    Edit Profile
                  </button>
                )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {collections.map((collection) => (
                <button
                  ...
                  className="text-left p-6 border border-gray-200 dark:border-gray-800 rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors"
                >

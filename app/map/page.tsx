...
import { Search, X, List, ChevronRight, SlidersHorizontal, Globe2, LayoutGrid, Map, Plus } from 'lucide-react';
...
export default function MapPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
      ...
      {/* Top Controls - Horizontal, Left Aligned, Medium Spacing */}
      <div className="relative left-0 right-0 z-10 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
        <div className="w-full px-6 md:px-10 lg:px-12 py-4">
          <div className="flex items-center gap-4">
            ...
            {/* 3. View Toggle - Grid/Map */}
            <div className="flex items-center bg-gray-100 dark:bg-gray-800 rounded-full p-1 flex-shrink-0">
              <button
                onClick={() => router.push('/')}
                className="flex items-center gap-1.5 px-3 py-2 text-sm font-medium transition-all rounded-full hover:text-gray-900 dark:hover:text-white"

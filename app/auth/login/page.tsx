  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 px-6 md:px-10 py-20">
      <div className="w-full max-w-md mx-auto">
        ...
        <button
          onClick={() => router.push('/')}
          className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors mb-12"
          aria-label="Back"
        >

...
export default function HomePageClient({
  ...
  // --- BOLT OPTIMIZATION: Hoisted Logic Start ---
  ...
  const paginatedDestinations = useMemo(() => {
    // Optimization: don't slice if map view
  ...
  const handleTouchStart = useCallback(
    ...
    [totalPages]
  ); // gridSwipeState is a ref, stable
  ...
  const renderDestinationItem = useCallback(
    ...
    [
      ...
      currentPage,
      itemsPerPage,
      openIntelligentDestination,
      trackDestinationEngagement,
    ]
  );

  // --- BOLT OPTIMIZATION End ---

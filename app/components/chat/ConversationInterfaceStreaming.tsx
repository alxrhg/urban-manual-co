  ...
  return (
    ...
    >
      <div className="w-full max-w-3xl mb-4 px-4 pointer-events-auto">
        {/* Chat Container */}
        <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-2xl rounded-lg shadow-2xl border border-white/20 dark:border-white/10">
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b border-gray-200/50 dark:border-gray-800/50">
            ...
            <button
              onClick={onClose}
              className="p-1.5 hover:bg-gray-100 dark:hover:bg-dark-blue-700 rounded-lg transition-colors"
            >

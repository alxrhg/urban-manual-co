        ...
        <div className="p-6 bg-white dark:bg-gray-900">
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 px-4 py-3 border border-gray-200 dark:border-gray-800 rounded-lg text-sm focus:outline-none focus:border-gray-400 dark:focus:border-gray-500 bg-white dark:bg-gray-800 text-black dark:text-white"
            />
            <button
              onClick={handleSend}

...
export default function DynamicPrompt({ city, category, className = '' }: DynamicPromptProps) {
  ...
  return (
    <div className={`bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 ${className}`}>

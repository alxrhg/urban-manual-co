        ...
        {trending.map((dest, index) => (
          ...
          >
            <div className={CARD_MEDIA}>
              ...
              {/* Trending Badge */}
              <div className="absolute top-2 left-2 px-3 py-1 border border-gray-200 dark:border-gray-800 rounded-lg text-gray-600 dark:text-gray-400 text-xs bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm flex items-center gap-1.5">
                <TrendingUp className="h-3 w-3" />
                {index < 3 && '#' + (index + 1)}
              </div>

              {/* Growth Rate */}
              <div className="absolute bottom-2 right-2 px-3 py-1 border border-gray-200 dark:border-gray-800 rounded-lg text-gray-600 dark:text-gray-400 text-xs bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm">

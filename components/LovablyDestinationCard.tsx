    ...
    >
      ...
      <div className="absolute top-2 right-2 flex flex-col gap-2 z-20">
        ...
        {destination.michelin_stars && destination.michelin_stars > 0 && (
          <div className="px-3 py-1 border border-gray-200 dark:border-gray-800 rounded-lg text-gray-600 dark:text-gray-400 text-xs bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm flex items-center gap-1.5">
            <img

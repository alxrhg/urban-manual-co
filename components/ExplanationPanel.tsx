...
export function ExplanationPanel({ destinationId, method = 'shap', trigger = 'click' }: ExplanationPanelProps) {
  ...
  if (trigger === 'hover') {
    return (
      ...
      >
        <button className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-xs hover:bg-gray-200 dark:hover:bg-gray-700">

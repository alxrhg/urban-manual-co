      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Mobile-only badge when filters active */}
            {hasActiveFilters && (
              <span className="sm:hidden absolute -top-1 -right-1 flex items-center justify-center min-w-[18px] h-[18px] px-1.5 text-[11px] bg-blue-500 text-white rounded-full">

...
function StatPill({ value, label }: { value: number; label: string }) {
  return (
    <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-stone-100 dark:bg-stone-800">
  ...
  return (
    <button
      ...
      className={`group flex flex-col items-center justify-center gap-2 p-5 sm:p-4 rounded-2xl border transition-all duration-200 active:scale-[0.98] min-h-[100px] sm:min-h-[88px] ${
        accent
          ? 'bg-stone-900 dark:bg-white border-stone-900 dark:border-white hover:bg-stone-800 dark:hover:bg-stone-100'
    ...
    >
      <div className={`p-2.5 sm:p-2 rounded-xl transition-transform group-hover:scale-110 ${
        ...
        <Icon className={`w-5 h-5 sm:w-4 sm:h-4 ${
          accent ? 'text-white dark:text-stone-900' : 'text-stone-600 dark:text-stone-300'
        }`} />
      </div>
      <div className="text-center">
        <p className={`text-sm sm:text-xs font-medium ${
          accent ? 'text-white dark:text-stone-900' : 'text-stone-900 dark:text-white'
        }`}>
          {label}
        </p>
        {count !== undefined && (
          <p className={`text-xs mt-0.5 ${
            accent ? 'text-white/70 dark:text-stone-900/70' : 'text-stone-500 dark:text-stone-400'
          }`}>
    ...
    <button
      ...
      className={`group w-full flex items-center justify-between gap-3 px-4 py-3.5 sm:py-3 rounded-xl transition-colors min-h-[52px] sm:min-h-[44px] ${
        danger
          ...
          : 'text-stone-600 dark:text-stone-300 hover:bg-stone-100 dark:hover:bg-stone-800 active:bg-stone-200 dark:active:bg-stone-700'
      }`}
    >
      ...
      <ChevronRight className={`w-4 h-4 transition-transform group-hover:translate-x-0.5 ${
        danger ? 'text-red-400 dark:text-red-500' : 'text-stone-400 dark:text-stone-500'
      }`} />
    </button>
  );
}
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-8 sm:px-10 pb-8 text-center">
          ...
          <div className="relative mb-8">
            <div className="w-28 h-28 sm:w-24 sm:h-24 rounded-full bg-gradient-to-br from-stone-100 to-stone-200 dark:from-stone-800 dark:to-stone-900 flex items-center justify-center">
              <Sparkles className="w-12 h-12 sm:w-10 sm:h-10 text-stone-400 dark:text-stone-500" />
            </div>
            <div className="absolute -bottom-1 -right-1 w-10 h-10 sm:w-8 sm:h-8 rounded-full bg-stone-900 dark:bg-white flex items-center justify-center">
              <User className="w-5 h-5 sm:w-4 sm:h-4 text-white dark:text-stone-900" />
            </div>
          </div>
          ...
          <p className="text-base sm:text-sm text-stone-500 dark:text-stone-400 mb-10 max-w-[280px] leading-relaxed">
          ...
          <button
            ...
            className="w-full max-w-[280px] py-4 sm:py-3.5 rounded-2xl sm:rounded-xl bg-stone-900 dark:bg-white text-white dark:text-stone-900 text-base sm:text-sm font-medium hover:opacity-90 active:scale-[0.98] transition-all min-h-[56px] sm:min-h-[48px]"
          >
            Get Started
          </button>
    ...
    <div className="h-full flex flex-col bg-white dark:bg-stone-950">
      ...
      <div className="px-5 sm:px-6 pt-6 sm:pt-5 pb-5">
        <div className="flex items-start justify-between gap-4">
          ...
          >
            {/* Avatar */}
            <div className="relative w-14 h-14 sm:w-12 sm:h-12 flex-shrink-0 rounded-full overflow-hidden bg-stone-100 dark:bg-stone-800 ring-2 ring-stone-200 dark:ring-stone-700 group-hover:ring-stone-300 dark:group-hover:ring-stone-600 transition-all">
              {avatarUrl ? (
                <Image
                  src={avatarUrl}
                  alt="Profile"
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <span className="text-xl sm:text-lg font-medium text-stone-400 dark:text-stone-500">
            ...
            <div className="min-w-0 text-left">
              ...
              <p className="text-sm sm:text-xs text-stone-500 dark:text-stone-400 truncate">
                View profile
              </p>
            </div>
          </button>

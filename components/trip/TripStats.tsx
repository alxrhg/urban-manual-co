  ...
  return (
    <div className={`grid grid-cols-2 md:grid-cols-4 gap-4 ${className}`}>
      ...
      <div className="p-4 border border-gray-200 dark:border-gray-800 rounded-2xl">
        <div className="text-2xl font-light mb-1 text-gray-900 dark:text-white">{totalStops}</div>
      ...
      {/* Total Days */}
      <div className="p-4 border border-gray-200 dark:border-gray-800 rounded-2xl">
        <div className="text-2xl font-light mb-1 text-gray-900 dark:text-white">{totalDays}</div>
        <div className="text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1.5">
      ...
      {/* Categories */}
      <div className="p-4 border border-gray-200 dark:border-gray-800 rounded-2xl">
        <div className="text-2xl font-light mb-1 text-gray-900 dark:text-white">{categories.size}</div>
        <div className="text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1.5">
      ...
      <div className="p-4 border border-gray-200 dark:border-gray-800 rounded-2xl">
        {dateRange ? (
          <>
            <div className="text-sm font-light mb-1 text-gray-900 dark:text-white truncate">{dateRange}</div>
            <div className="text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1.5">
          ...
          <>
            <div className="text-sm font-light mb-1 text-gray-900 dark:text-white truncate">{destination}</div>
            <div className="text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1.5">
              <MapPin className="w-3 h-3" />
              Destination
            </div>
          ...
          <>
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400">No dates set</div>
          </>
        )}
      </div>
    </div>

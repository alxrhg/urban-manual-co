      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        {starters.map((starter, index) => (
          <button
            ...
            className="group text-left px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-dark-blue-700 hover:border-gray-300 dark:hover:border-gray-700 transition-all duration-200"
          >

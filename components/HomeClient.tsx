 ...
 * Initial data is fetched server-side and passed as props for SSR
 */
export interface HomeClientProps {
  /** Initial destinations loaded server-side */
  initialDestinations: Destination[];
  /** Initial list of cities for filters */
  initialCities: string[];
  /** Initial list of categories for filters */
...
/**
 * HomeClient - Client component for the homepage
 * Handles all interactive features while receiving initial data from server
 */
export function HomeClient({
  ...
  // Initialize state with server-side data for instant render
  ...
  useEffect(() => {
    ...
    // Only fetch data if we don't have SSR data
    // This prevents unnecessary API calls when data was pre-loaded server-side
    ...
    // Always fetch filter data for enhancement (Discovery Engine may have more)
  ...
  return (
    <ErrorBoundary>
      ...
      />
      {/* Container div - main tag is already in layout.tsx */}

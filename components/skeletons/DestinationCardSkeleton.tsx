...
export function DestinationCardSkeleton() {
  return (
    <div className="group animate-pulse w-full">
      {/* Image skeleton */}
      <div className="aspect-video bg-gray-200 dark:bg-gray-800 rounded-xl mb-4 relative overflow-hidden">
        {/* Shimmer effect */}
      ...
      <div className="space-y-1 px-1">
        <div className="h-5 bg-gray-200 dark:bg-gray-800 rounded w-3/4 mb-2 relative overflow-hidden">
          <div className="absolute inset-0 -translate-x-full animate-[shimmer_2s_infinite] bg-gradient-to-r from-transparent via-white/10 to-transparent" />
        </div>

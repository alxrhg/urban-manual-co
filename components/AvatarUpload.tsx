    ...
    <div className="flex flex-col items-center gap-4">
      <div className="relative">
        ...
        <button
          ...
          disabled={uploading}
          className="absolute bottom-0 right-0 w-10 h-10 bg-white dark:bg-dark-blue-800 rounded-full shadow-lg flex items-center justify-center border-2 border-gray-200 dark:border-dark-blue-600 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors disabled:opacity-50"

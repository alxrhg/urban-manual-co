  ...
  return (
    <Drawer isOpen={isOpen} onClose={onClose}>
      <DrawerHeader
        ...
        subtitle={isSignUp ? 'Begin your journey' : 'Welcome back'}
      />
      ...
      <div className="overflow-y-auto max-h-[calc(100vh-4rem)] pb-16">
        <DrawerSection>
          <button
            ...
            disabled={loading}
            className="w-full px-6 py-3 bg-black dark:bg-white text-white dark:text-black rounded-full hover:opacity-80 transition-opacity text-sm font-medium disabled:opacity-50 flex items-center justify-center gap-2"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {isSignUp && (
              <div>
                ...
                <input
                  ...
                  required={isSignUp}
                  autoComplete="name"
                  className="w-full px-4 py-3 border border-gray-200 dark:border-gray-800 rounded-xl bg-white dark:bg-gray-900 focus:outline-none focus:border-black dark:focus:border-white transition-colors text-sm"
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
              />
              {isSignUp && <span className="text-xs text-gray-400 mt-1 block">Minimum 6 characters</span>}
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-6 py-3 bg-black dark:bg-white text-white dark:text-black rounded-full hover:opacity-80 transition-opacity text-sm font-medium disabled:opacity-50"
            >

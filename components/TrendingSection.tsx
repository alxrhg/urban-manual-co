        ...
        {destinations.map((dest) => (
          ...
          >
            <div className={CARD_MEDIA}>
              ...
              {dest.is_open_now && (
                <span className="absolute top-2 right-2 px-3 py-1 border border-gray-200 dark:border-gray-800 rounded-lg text-gray-600 dark:text-gray-400 text-xs bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm">
                  OPEN NOW
                </span>
              )}

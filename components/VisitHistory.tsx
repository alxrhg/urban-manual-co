      ...
      {history.map((item) => {
        ...
        return (
          <div
            ...
            className="flex items-center gap-4 p-3 bg-white dark:bg-dark-blue-800 rounded-2xl border border-gray-200 dark:border-dark-blue-600 hover:border-gray-300 dark:hover:border-gray-600 cursor-pointer transition-colors group"
          >
            {dest.image ? (
              ...
              <div className="w-16 h-16 flex-shrink-0 bg-gray-100 dark:bg-dark-blue-700 rounded-2xl flex items-center justify-center">

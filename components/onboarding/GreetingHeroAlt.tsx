...
import { generateContextualGreeting, generateContextualPlaceholder, type GreetingContext } from '@/services/greetings/main';
import { UserProfile } from '@/types/personalization';
import { JourneyInsights } from '@/services/greetings/journey-tracker';
import { RecentAchievement } from '@/services/greetings/achievement-helper';
import { GreetingWeatherData } from '@/services/greetings/weather-helper';

...
export function EditTripModal({ isOpen, onClose, trip }: EditTripModalProps) {
  ...
  const updateTrip = trpc.trips.updateTrip.useMutation({
    onSuccess: () => {
      ...
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end gap-4">
            ...
            <button type="submit" className="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" disabled={updateTrip.isLoading}>

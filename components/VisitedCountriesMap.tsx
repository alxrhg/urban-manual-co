...
export default function VisitedCountriesMap({ visitedPlaces, savedPlaces = [] }: VisitedCountriesMapProps) {
  ...
  return (
    <div className="w-full space-y-4">
      ...
      <div className="w-full h-64 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-800 dark:to-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 relative overflow-hidden">
          ...
          <div className="grid grid-cols-3 md:grid-cols-4 gap-3 p-4 w-full">
            {visitedCountries.slice(0, 12).map((country, idx) => {
              ...
              return (
                <div
                  key={country}
                  className="flex flex-col items-center justify-center bg-white dark:bg-gray-800 rounded-lg p-2 shadow-sm border border-gray-200 dark:border-gray-800"
                  style={{
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
        {visitedCountries.map((country) => {
          ...
          return (
            <div
              key={country}
              className="flex items-center gap-2 px-3 py-2 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 hover:bg-gray-100 dark:hover:bg-dark-blue-700 transition-colors"
            >

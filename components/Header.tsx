      ...
      {isMenuOpen && (
        <>
          ...
          >
            ...
            <div className="py-2">
              <button onClick={() => { navigate('/chat'); setIsMenuOpen(false); }} className="block w-full text-left px-4 py-3 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 touch-manipulation">Chat</button>

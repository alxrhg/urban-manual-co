...
export function SessionResume({ session, onResume, onDismiss }: SessionResumeProps) {
  ...
  return (
    <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-gray-50 dark:from-blue-900/20 dark:to-gray-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">

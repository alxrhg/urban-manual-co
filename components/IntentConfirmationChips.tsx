    ...
    <div className="flex flex-wrap gap-2">
      {chips.map((chip, index) => (
        <div
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gray-100 dark:bg-dark-blue-800 border border-gray-200 dark:border-dark-blue-600 rounded-full text-xs font-medium text-gray-700 dark:text-gray-300 transition-all hover:bg-gray-200 dark:hover:bg-gray-700"
        >

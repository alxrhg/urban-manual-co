    ...
    <div className="fixed inset-x-0 bottom-0 z-50 flex flex-col items-center pointer-events-none">
      ...
      {messages.length > 0 && (
        <div className="w-full max-w-3xl mb-4 px-4 pointer-events-auto">
          <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-2xl rounded-3xl shadow-2xl border border-gray-200 dark:border-white/10 max-h-[60vh] overflow-y-auto">
      ...
      <div className="w-full max-w-3xl px-4 pb-6 pointer-events-auto">
        <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-2xl rounded-3xl shadow-2xl border border-gray-200 dark:border-white/10 p-4">
          <form onSubmit={handleSubmit} className="flex items-end gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="p-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-white rounded-lg hover:scale-105 transition-transform"
              >
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 text-xs bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-black dark:text-white rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-all"
                  >
                    {suggestion}
                  </button>
                ))}

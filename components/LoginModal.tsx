      ...
      <DialogContent className="sm:max-w-[420px] p-0 gap-0 overflow-hidden">
        ...
        <div className="px-6 pb-6 space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full px-6 py-3.5 bg-black dark:bg-white text-white dark:text-black rounded-lg hover:opacity-90 active:opacity-80 transition-opacity text-sm font-medium disabled:opacity-50 flex items-center justify-center gap-3"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-6 py-3.5 bg-black dark:bg-white text-white dark:text-black rounded-lg hover:opacity-90 active:opacity-80 transition-opacity text-sm font-medium disabled:opacity-50 mt-2"
            >

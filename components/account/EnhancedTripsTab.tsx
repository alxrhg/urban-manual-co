  ...
  if (trips.length === 0) {
    return (
      <div className="max-w-md py-12">
        ...
        <button
          onClick={onNewTrip}
          className="px-6 py-2 bg-black dark:bg-white text-white dark:text-black text-xs font-medium rounded-2xl hover:opacity-80 transition-opacity inline-flex items-center gap-2"
        >
  ...
  return (
    <div className="max-w-2xl space-y-8">
      ...
      <div className="p-4 rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800">
        ...
        <button
          onClick={onNewTrip}
          className="px-4 py-2 bg-black dark:bg-white text-white dark:text-black text-xs font-medium rounded-2xl hover:opacity-80 transition-opacity inline-flex items-center gap-2"
        >
          <Plus className="w-4 h-4" />
          Plan a New Trip
        </button>
